...
describe('File Operations Module', () => {
  ...
  describe('createTempFile', () => {
    ...
    it('should create a temporary file with content', async () => {
      ...
      const result = await fileOperations.createTempFile('test content', {
        prefix: 'test',
        suffix: '.txt',
      });
  ...
  describe('copyFile', () => {
    ...
    it('should throw an error if the source file does not exist', async () => {
      ...
      // Mock copyFile to use our implementation
      await expect(
        fileOperations.copyFile('/path/to/nonexistent.txt', '/path/to/destination.txt'),
      ).rejects.toThrow();
    ...
    it('should throw an error if the destination file exists and overwrite is false', async () => {
      ...
      // Mock copyFile to use our implementation
      await expect(
        fileOperations.copyFile('/path/to/source.txt', '/path/to/destination.txt'),
      ).rejects.toThrow();
