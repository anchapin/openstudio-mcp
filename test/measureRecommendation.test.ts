...
describe('Measure Recommendation System', () => {
  ...
  describe('recommendMeasures', () => {
    ...
    it('should enhance recommendations when a model path is provided', async () => {
      ...
      const result = await bclApiClient.recommendMeasures('energy efficiency', '/path/to/office_model.osm');
  ...
  describe('Context Analysis', () => {
    ...
    it('should extract relevant keywords from context', async () => {
      ...
      await bclApiClient.recommendMeasures('I need to improve the energy efficiency of my HVAC system and reduce lighting costs');
